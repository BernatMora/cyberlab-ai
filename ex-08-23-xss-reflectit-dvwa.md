---
id: EX-08-23
title: "XSS reflectit - Explicat per a gent inexperta"
status: draft
version: 2.0
created: 2026-08-07
updated: 2026-08-07
...
# EX-08-23 - XSS reflectit - Explicat per a gent inexperta

> Aprendre a fer un XSS reflectit al DVWA.

## Que necessites saber

Aquest exercici ja esta **molt ben explicat**. Si vols aprendre XSS:

1. **Llegeix** [EX-08-03 complet](ex-08-03-xss-reflectit-dvwa.md) - ja sha reescrit amb explicacions
2. **Si no entens**, llegeix primer [ANN-09](ann-09-comencar-de-zero.md)

### Resum rapid

- **XSS**: Cross-Site Scripting
- **JavaScript**: llenguatge de les webs
- **`<script>`**: etiqueta HTML per incloure JS
...
1. Llegeix [EX-08-03 complet](ex-08-03-xss-reflectit-dvwa.md)
